...
- [x] Créer contexts/ThemeContext.tsx
- [x] State darkMode (boolean)
- [x] AsyncStorage persistance (clé: 'dark_mode_enabled')
- [x] Hook useTheme() pour accès facile
- [x] Wrapper App.tsx avec ThemeProvider
- [x] Modifier tous les écrans :
  - [x] CalendarScreen.tsx
  - [x] TasksScreen.tsx
  - [x] SettingsScreen.tsx
  - [ ] Autres écrans (non nécessaire, pas de useColorScheme)
- [x] Connecter toggle SettingsScreen au Context
- [x] Palette stricte appliquée (#000000, #2a2a2a, #ffffff)


## 📅 AMÉLIORATIONS CALENDRIER (FINITION)

**Objectif :** Finaliser le Calendrier avec toutes les fonctionnalités manquantes

### 1. Toggle vues : Icônes uniquement ✅
- [x] Remplacer texte "Mois" par icône 📅 + "30"
- [x] Remplacer texte "Semaine" par icône 📆 + "7"
- [x] Remplacer texte "Jour" par icône 🗓️ + "1"
- [x] Remplacer texte "Agenda" par icône 📝 seule
- [x] Styles viewToggleIcon + viewToggleNumber
- [x] Layout vertical (flexDirection: column)

### 2. Clic sur jour vide → Modal création événement ✅
- [x] Détecter clic sur jour du calendrier (vue Mois)
- [x] Vérifier si le jour a des événements
- [x] Si vide : Ouvrir modal création avec date pré-remplie (09:00-10:00)
- [x] Utiliser le formulaire de création existant

### 3. Clic sur jour avec événements → Dropdown ✅
- [x] Si jour a événements : Ouvrir dropdown/modal liste
- [x] En haut : Bouton "+ Ajouter événement" (ouvre création)
- [x] Liste des événements du jour (heure + titre + catégorie + icône + privé)
- [x] Clic sur événement : Ouvrir modal modification/suppression
- [x] Fermeture : Clic extérieur ou bouton Fermer

### 4. Carte "Jeudi 12 Février" : Afficher événements filtrés ✅
- [x] Respecter le toggle sélectionné (Mois/Semaine/Jour/Agenda)
- [x] Afficher uniquement les événements correspondants
  - [x] Mois/Jour : Événements du jour sélectionné
  - [x] Semaine : Événements de la semaine actuelle
  - [x] Agenda : Tous les événements à venir
- [x] Mise à jour dynamique lors du changement de toggle
- [x] Titre adapté selon le mode (jour/semaine/à venir)

### 5. Filtres événements ✅
- [x] Ajouter bouton "Filtres" dans header avec badge (nombre de filtres actifs)
- [x] Modal filtres avec options :
  - [x] Par catégorie (6 checkboxes avec icônes)
  - [x] Par membre (checkboxes dynamiques depuis family.members)
  - [x] Bouton "Réinitialiser"
  - [x] Bouton "Annuler"
  - [x] Bouton "Appliquer"
- [x] Sauvegarder filtres actifs (AsyncStorage)
- [x] Appliquer filtres à toutes les vues (Mois/Semaine/Jour/Agenda)
- [x] Chargement automatique des filtres au démarrage

### 6. Import ICS / Abonnement calendrier ✅ (Version basique)
- [x] Ajouter bouton "Import" dans header (vert 📅)
- [x] Modal import avec sélection fichier .ics
- [x] Parser fichier .ics (parser basique sans librairie)
  - [x] SUMMARY (titre)
  - [x] DESCRIPTION
  - [x] DTSTART (date/heure début)
  - [x] DTEND (durée calculée)
- [x] Créer événements en DB depuis .ics
- [x] Alert de confirmation avec nombre d'événements importés
- [x] Gestion des erreurs avec Alert
- [ ] **Non implémenté (complexité) :**
  - [ ] Événements récurrents (RRULE)
  - [ ] Abonnement URL calendrier
  - [ ] Option annulation import
  - [ ] Synchronisation périodique

### 7. Tests et validation
- [ ] Tester clic jour vide/plein
- [ ] Tester dropdown événements
- [ ] Tester filtres
- [ ] Tester import .ics
- [ ] Tester annulation import
- [ ] Vérifier toutes les vues (Mois/Semaine/Jour/Agenda)
=======
## 🎨 CONTEXT GLOBAL DARK MODE
