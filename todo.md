...
- [x] Aligner la saisie Messages Android sur les insets réels du clavier afin de reproduire le positionnement natif au-dessus du clavier flottant.
...
- [x] Analyser puis corriger les anomalies de l’écran Messages relevées dans la vidéo de validation Android.
...
- [x] Synchroniser la préférence de langue de l’application avec le profil serveur de chaque utilisateur.
- [ ] Traduire exhaustivement les e-mails, notifications push, rappels, messages système et erreurs serveur en FR, EN, DE, ES et IT.
...
- [x] Corriger la reprise après vérification e-mail ou WhatsApp lorsqu’elle ouvre encore l’inscription au lieu de la connexion préremplie.
- [x] Afficher et rendre copiable le code alphanumérique du cercle depuis sa fiche détaillée.
- [x] Afficher la saisie d’adresse d’invitation entièrement au-dessus du clavier Android.
...
- [x] Retirer toute copie ou affichage manuel du code nominatif d’invitation afin que seul le code générique de cercle soit copiable.
...
- [x] Afficher un avertissement lorsqu’un administrateur non participant tente de valider une tâche commune.
...
- [x] Pousser le correctif serveur et le correctif mobile preview des tâches communes avant le test Android.
