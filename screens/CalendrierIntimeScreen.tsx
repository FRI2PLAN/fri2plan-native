...
const getStyles = (isDark: boolean) => StyleSheet.create({
  ...
  tabBtn: { flex: 1, paddingVertical: 8, borderRadius: 20, backgroundColor: isDark ? '#1f2937' : '#fff', borderWidth: 1, borderColor: isDark ? '#374151' : '#e5e7eb', alignItems: 'center', justifyContent: 'center' },
  tabBtnActive: { backgroundColor: '#ec4899', borderColor: '#ec4899' },
  tabBtnText: { fontSize: 11, fontWeight: '600', color: isDark ? '#d1d5db' : '#374151', textAlign: 'center' },
  ...
  modalContent: { backgroundColor: isDark ? '#1f2937' : '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, maxHeight: '90%', flexGrow: 0 },
