    ...
    const initGoogle = async () => {
      try {
        GoogleSignin.configure({
          webClientId: '846470017457-qh90rioca6oujshvm05p23b5do8fbv6t.apps.googleusercontent.com', // TODO: migrer vers projet 582461718885 quand consolidation Google Cloud faite
