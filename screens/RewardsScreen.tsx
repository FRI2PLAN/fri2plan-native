...
const getStyles = (isDark: boolean) => StyleSheet.create({
  ...
  availableNowPill: { alignItems: 'center', alignSelf: 'stretch', backgroundColor: '#D1FAE5', borderRadius: 99, marginTop: 12, paddingHorizontal: 14, paddingVertical: 7 },
  availableNowText: { color: '#065F46', flexShrink: 1, fontSize: 13, fontWeight: '800', textAlign: 'center' },
